...
# if __name__ == "__main__":
    ...
    # images_folder_path = r'C:\Users\Administrator\Desktop\Figure\final_frames'

    # Call the all_in_folder function with the images folder path
    # outputs = all_in_folder(images_folder_path)

    # Specify the paths to save the raw text and JSON output
    # raw_text_save_file = "raw_text.txt"
    # json_output_save_file = "output.json"

    # Write the raw text and JSON output to files
    # write_to_file(outputs[0], outputs[1], raw_text_save_file, json_output_save_file)
